...
for(replicate in 1:30){
  ...
  data_split = split_data(data, num_training, num_validation, 'class', seed = replicate * 13)
  ...
  # Get pca-transformed value for each training sample
  pca_matrix = get_pca_matrix(data_training, num_features_true, data_start_idx_true, 'class', num_axes) 
  data_training_pca = get_pca_points(data_training, pca_matrix, num_features_true, data_start_idx_true, 'class', num_axes)   
  data_validation_pca = get_pca_points(data_validation, pca_matrix, num_features_true, data_start_idx_true, 'class', num_axes)   
  data_testing_pca = get_pca_points(data_testing, pca_matrix, num_features_true, data_start_idx_true, 'class', num_axes)   
  for(col_idx in 1:num_axes){
    data_training[,paste0('pca_', col_idx)] = data_training_pca[,col_idx + 1] # +1 offset to skip class
    data_validation[,paste0('pca_', col_idx)] = data_validation_pca[,col_idx + 1] 
    data_testing[,paste0('pca_', col_idx)] = data_testing_pca[,col_idx + 1] 
  }
  ...
  write.matrix(confusion_mat, paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_knn.csv'))
  ...
  ggplot(data_confusion, aes(x = x, y = -y, fill = count)) + 
    ...
    ylab('True Class') + 
    ggsave(paste0('./plots/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_knn.pdf'), units = 'in', width = 6, height = 6)
  ...
  write.matrix(confusion_mat, paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_rf.csv'))
  ...
  ggplot(data_confusion, aes(x = x, y = -y, fill = count)) + 
    ...
    xlab('Predicted class') +
    ylab('True Class') + 
    ggsave(paste0('./plots/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_rf.pdf'), units = 'in', width = 6, height = 6)
  ...
  write.matrix(confusion_mat, paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_svm.csv'))
  ...
  ggplot(data_confusion, aes(x = x, y = -y, fill = count)) + 
    ...
    xlab('Predicted class') +
    ylab('True Class') + 
    ggsave(paste0('./plots/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_svm.pdf'), units = 'in', width = 6, height = 6)
  ...
  write.matrix(confusion_mat, paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_bayes.csv'))
  ...
  ggplot(data_confusion, aes(x = x, y = -y, fill = count)) + 
    ...
    xlab('Predicted class') +
    ylab('True Class') + 
    ggsave(paste0('./plots/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', replicate, '_bayes.pdf'), units = 'in', width = 6, height = 6)
  
}
write.matrix(confusion_mat_knn_all, paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'knn_all.csv'))
write.matrix(confusion_mat_rf_all,  paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'rf_all.csv'))
write.matrix(confusion_mat_svm_all, paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'svm_all.csv'))
write.matrix(confusion_mat_bayes_all, paste0('./confusion_matrices/pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'bayes_all.csv'))
write.csv(data_knn_all, paste0('./pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'knn_all.csv'))
write.csv(data_rf_all,  paste0('./pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'rf_all.csv'))
write.csv(data_svm_all, paste0('./pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'svm_all.csv'))
write.csv(data_results, paste0('./pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'results.csv'))
...
ggplot(data_results, aes(x = as.factor(classifier_str), y = error_pct)) + 
  ...
  ggsave(paste0('./pca_', num_axes, '__train_', num_training, '__val_', num_validation, '__', 'results.pdf'), units = 'in', width = 6, height = 6)
