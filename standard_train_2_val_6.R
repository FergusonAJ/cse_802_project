...
colnames(data_svm_all) = c('max_nodes', 'cost', 'replicate')
...
for(replicate in 1:30){
  ...
  data_split = split_data(data, num_training, num_validation, 'class', seed = replicate * 12)
  ...
  write.matrix(confusion_mat, paste0('./confusion_matrices/train_', num_training, '__val_', num_validation, '__', replicate, '_knn.csv'))
  ...
  ggplot(data_confusion, aes(x = x, y = -y, fill = count)) + 
    ...
    ylab('True Class') + 
    ggsave(paste0('./plots/train_', num_training, '__val_', num_validation, '__', replicate, '_knn.pdf'), units = 'in', width = 6, height = 6)
  ...
  write.matrix(confusion_mat, paste0('./confusion_matrices/train_', num_training, '__val_', num_validation, '__', replicate, '_rf.csv'))
  ...
  ggplot(data_confusion, aes(x = x, y = -y, fill = count)) + 
    ...
    xlab('Predicted class') +
    ylab('True Class') + 
    ggsave(paste0('./plots/train_', num_training, '__val_', num_validation, '__', replicate, '_rf.pdf'), units = 'in', width = 6, height = 6)
  ...
  write.matrix(confusion_mat, paste0('./confusion_matrices/train_', num_training, '__val_', num_validation, '__', replicate, '_svm.csv'))
  ...
  ggplot(data_confusion, aes(x = x, y = -y, fill = count)) + 
    ...
    xlab('Predicted class') +
    ylab('True Class') + 
    ggsave(paste0('./plots/train_', num_training, '__val_', num_validation, '__', replicate, '_svm.pdf'), units = 'in', width = 6, height = 6)
...
write.matrix(confusion_mat_knn_all, paste0('./confusion_matrices/train_', num_training, '__val_', num_validation, '__', 'knn_all.csv'))
write.matrix(confusion_mat_rf_all,  paste0('./confusion_matrices/train_', num_training, '__val_', num_validation, '__', 'rf_all.csv'))
write.matrix(confusion_mat_svm_all, paste0('./confusion_matrices/train_', num_training, '__val_', num_validation, '__', 'svm_all.csv'))
write.csv(data_knn_all, paste0('./train_', num_training, '__val_', num_validation, '__', 'knn_all.csv'))
write.csv(data_rf_all,  paste0('./train_', num_training, '__val_', num_validation, '__', 'rf_all.csv'))
write.csv(data_svm_all, paste0('./train_', num_training, '__val_', num_validation, '__', 'svm_all.csv'))
write.csv(data_results, paste0('./train_', num_training, '__val_', num_validation, '__', 'results.csv'))
...
ggplot(data_results, aes(x = as.factor(classifier_str), y = error_pct)) + 
  ...
  ggsave(paste0('./train_', num_training, '__val_', num_validation, '__', 'results.pdf'), units = 'in', width = 6, height = 6)
